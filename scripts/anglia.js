...
const city = [{
    ...
    priceCents: 20000,
    hotels: 'https://www.booking.com/Birmingham',
    planes: 'https://www.kiwi.com/ro/search/results/bucuresti-romania/birmingham-regatul-unit'
}, {
    id: "15b6fc6f-327a-4ec4-896f-486349e85a3d",
    image: 'img/carlise.jpg',
    name: 'Carlise',
    description: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut, doloribus!',
    rating: {
        stars: [
    ...
    priceCents: 19500,
    hotels: 'https://www.booking.com/Carlisle',
    planes: 'https://www.kiwi.com/ro/search/results/bucuresti-romania/carlisle-united-kingdom'
}, {
    ...
    priceCents: 25000,
    hotels: 'https://www.booking.com/london',
    planes: 'https://www.kiwi.com/ro/search/results/bucuresti-romania/londra-regatul-unit'
}];
...
document.querySelector('.js-anglia-cards').innerHTML = cityHTML;
