...
const city = [{
    id: "e43638ce-6aa0-4b85-b27f-e1d07eb678c67",
    image: 'img/lisabona.jpg',
    name: 'Lisabona',
    ...
    priceCents: 37000,
    hotels: 'https://www.booking.com/lisabona',
    planes: 'https://www.kiwi.com/ro/search/results/bucuresti-romania/lisabona-portugalia'
}, {
    id: "15b6fc6f-327a-4ec4-896f-486349e85a3d7",
    image: 'img/porto.jpeg',
    name: 'Porto',
    description: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut, doloribus!',
    rating: {
        stars: [
    ...
    priceCents: 37500,
    hotels: 'https://www.booking.com/porto',
    planes: 'https://www.kiwi.com/ro/search/results/bucuresti-romania/porto-portugalia'
}, {
    id: "83d4ca15-0f35-48f5-b7a3-1ea210004f2e7",
    image: 'img/lagos.jpg',
    name: 'Lagos',
    description: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut, doloribus!',
    rating: {
    ...
    priceCents: 37000,
    hotels: 'https://www.booking.com/lagos',
    planes: 'https://www.kiwi.com/ro/search/results/bucuresti-romania/lagos-portugal'
}];
...
document.querySelector('.js-portugalia-cards').innerHTML = cityHTML;
